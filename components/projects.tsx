  ...
  return (
    <section className="py-12 md:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <ScrollReveal>
          <h2 className="text-3xl md:text-4xl font-bold text-(--foreground) mb-4 text-balance">Projects</h2>
          <p className="text-base md:text-lg text-(--muted-text) mb-8 md:mb-12">Building and learning through applied projects</p>
        </ScrollReveal>
