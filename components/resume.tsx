        ...
        <div className="hidden md:grid md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col justify-center gap-6">
            <div>
              ...
              <Link href="/AravResume-8_26.pdf" className="btn-primary flex items-center justify-center gap-2 w-full" download>
                <Download size={20} />
                Download PDF
              </Link>
            </div>
        ...
        <div className="md:hidden">
          <div className="bg-(--card) rounded-xl p-8 shadow-sm border border-(--border-color) flex flex-col items-center text-center gap-6">
            ...
            <div className="flex flex-col gap-3 w-full max-w-xs">
              <Link href="/AravResume-8_26.pdf" className="btn-primary flex items-center justify-center gap-2 w-full">
                <FileText size={20} />
                View Resume
              </Link>
              <Link href="/AravResume-8_26.pdf" className="flex items-center justify-center gap-2 w-full px-6 py-3 rounded-lg border border-(--border-color) text-(--foreground) text-sm font-medium hover:bg-(--card) transition-colors" download>
                <Download size={18} />
                Download PDF
              </Link>
            </div>
