      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="md:hidden">
          <div className="bg-(--card) rounded-xl p-8 shadow-sm border border-(--border-color) flex flex-col items-center text-center gap-6">
            ...
            <div>
              <h3 className="text-lg font-bold text-(--foreground) mb-2">View My Resume</h3>
              <p className="text-sm text-(--muted-text)">Download the PDF to view my full resume. Last updated Jan 2026.</p>
            </div>
            <Link href="/Arav-Sarma_Resume.pdf" className="btn-primary flex items-center justify-center gap-2 w-full max-w-xs" download>
              <Download size={20} />
              Download PDF
            </Link>
          </div>
